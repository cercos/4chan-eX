SW.yotsuba =
  ...
  isThisPageLegit: ->
    ...
    (location.hostname in ['boards.4chan.org', 'boards.4channel.org'] or @isBoardlessPage location) and
    d.doctype and
  ...
  initAuxiliary: ->
    switch location.hostname
      when '4chan.org', 'www.4chan.org', '4channel.org', 'www.4channel.org', 'boards.4chan.org', 'boards.4channel.org'
