ModContact =
  ...
  specific:
    Mod:       -> `<%= html(' <a href="https://www.4chan-eX.net/4chan-irc.html" target="_blank">IRC</a>') %>`
  ...
  moveNote:
    qa: `<%= html(
      ...
      '<a href="https://www.4chan-eX.net/4chan-irc.html" target="_blank">IRC</a><span class="invisible"> (https://www.4chan-eX.net/4chan-irc.html)</span>.'
    ) %>`
